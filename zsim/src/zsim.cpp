    ...
    if (!procTreeNode->isInFastForward() || !zinfo->ffReinstrument) {
        ...
        if (INS_IsMemoryRead(ins)) {
            if (!INS_IsPredicated(ins)) {
                ...
                INS_InsertCall(ins, IPOINT_BEFORE, PredLoadFuncPtr, IARG_FAST_ANALYSIS_CALL, IARG_THREAD_ID, IARG_MEMORYREAD_EA, IARG_EXECUTING, IARG_INST_PTR, IARG_END);
            }
        }
        ...
        if (INS_HasMemoryRead2(ins)) {
            if (!INS_IsPredicated(ins)) {
                ...
                INS_InsertCall(ins, IPOINT_BEFORE, PredLoadFuncPtr, IARG_FAST_ANALYSIS_CALL, IARG_THREAD_ID, IARG_MEMORYREAD2_EA, IARG_EXECUTING, IARG_INST_PTR, IARG_END);
            }
        }
        ...
        if (INS_IsMemoryWrite(ins)) {
            if (!INS_IsPredicated(ins)) {
                ...
                INS_InsertCall(ins, IPOINT_BEFORE,  PredStoreFuncPtr, IARG_FAST_ANALYSIS_CALL, IARG_THREAD_ID, IARG_MEMORYWRITE_EA, IARG_EXECUTING, IARG_INST_PTR, IARG_END);
            }
        }
